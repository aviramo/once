create or replace function others (user_id uuid, location geography) returns table (
  user_id uuid,
  "user" json,
  other_id uuid,
  distance int,
  state text,
  relevance_gender float,
  relevance_restiction float,
  relevance_age float,
  relevance_location float,
  relevance_time float,
  relevance_subscription float,
  relevance_watchers float,
  relevance float
