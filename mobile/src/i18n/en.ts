...
Next may surprise`,
  ...
  'home.locked.watch.invite.word': 'Missed',
  'home.locked.watch.extend.word': 'Missed',
  'home.locked.watch.approve.word': 'Missed',
  'home.locked.watch.decline.word': 'Declined',
  'home.locked.watch.leave.word': 'Left',
  'home.locked.watch.block.word': 'Left',
  'home.locked.watch.remove.word': 'Gone',
  'home.locked.watch.expire.word': 'Ended',
  'home.locked.watch.logout.word': 'Signed out',
  'home.locked.watch.delete.word': 'Deleted',
  'home.locked.invite.cancel.word': 'Cancelled',
  'home.locked.invite.approve.word': 'Missed',
  'home.locked.invite.expire.word': 'Ended',
  'home.locked.invite.logout.word': 'Signed out',
  'home.locked.invite.delete.word': 'Deleted',
  ...
  // Locked watch cards reference the other user. `tg(key, otherMale)` picks _m
  // when the other user is male, _f when female. Only the other's gender
  // matters; "you" is gender-neutral in English.
  'home.locked.watch.invite.title': 'She\'s no longer available',
  'home.locked.watch.invite.title_m': 'He\'s no longer available',
  'home.locked.watch.invite.title_f': 'She\'s no longer available',
  'home.locked.watch.invite.desc': 'She\'s already in another invitation, so you can\'t send to her right now. You can move on',
  'home.locked.watch.invite.desc_m': 'He\'s already in another invitation, so you can\'t send to him right now. You can move on',
  'home.locked.watch.invite.desc_f': 'She\'s already in another invitation, so you can\'t send to her right now. You can move on',
  'home.locked.watch.extend.title': 'Can\'t extend',
  'home.locked.watch.extend.desc': 'The invitation has already closed. You can go back and find another connection',
  'home.locked.watch.approve.title': 'The connection is no longer available',
  'home.locked.watch.approve.desc': 'Something changed before you could connect. You can move on',
  'home.locked.watch.decline.title': 'She didn\'t accept this time',
  'home.locked.watch.decline.title_m': 'He didn\'t accept this time',
  'home.locked.watch.decline.title_f': 'She didn\'t accept this time',
  'home.locked.watch.decline.desc': 'She chose not to continue right now. All good, you can move on to the next connection',
  'home.locked.watch.decline.desc_m': 'He chose not to continue right now. All good, you can move on to the next connection',
  'home.locked.watch.decline.desc_f': 'She chose not to continue right now. All good, you can move on to the next connection',
  'home.locked.watch.leave.title': 'The chat ended',
  'home.locked.watch.leave.desc': 'She left the chat. You can go back and find a new connection',
  'home.locked.watch.leave.desc_m': 'He left the chat. You can go back and find a new connection',
  'home.locked.watch.leave.desc_f': 'She left the chat. You can go back and find a new connection',
  'home.locked.watch.block.title': 'The chat ended',
  'home.locked.watch.block.desc': 'She chose to end the connection. You can move on',
  'home.locked.watch.block.desc_m': 'He chose to end the connection. You can move on',
  'home.locked.watch.block.desc_f': 'She chose to end the connection. You can move on',
  'home.locked.watch.remove.title': 'She\'s no longer available to you',
  'home.locked.watch.remove.title_m': 'He\'s no longer available to you',
  'home.locked.watch.remove.title_f': 'She\'s no longer available to you',
  'home.locked.watch.remove.desc': 'She removed you from her viewers list. You can go back and find another connection',
  'home.locked.watch.remove.desc_m': 'He removed you from his viewers list. You can go back and find another connection',
  'home.locked.watch.remove.desc_f': 'She removed you from her viewers list. You can go back and find another connection',
  'home.locked.watch.expire.title': 'She didn\'t reply in time',
  'home.locked.watch.expire.title_m': 'He didn\'t reply in time',
  'home.locked.watch.expire.title_f': 'She didn\'t reply in time',
  'home.locked.watch.expire.desc': 'Time passed without a reply. You can move on and send an invitation to someone else',
  'home.locked.watch.logout.title': 'She\'s no longer here',
  'home.locked.watch.logout.title_m': 'He\'s no longer here',
  'home.locked.watch.logout.title_f': 'She\'s no longer here',
  'home.locked.watch.logout.desc': 'She left the app or isn\'t available right now. You can move on',
  'home.locked.watch.logout.desc_m': 'He left the app or isn\'t available right now. You can move on',
  'home.locked.watch.logout.desc_f': 'She left the app or isn\'t available right now. You can move on',
  'home.locked.watch.delete.title': 'She\'s no longer here',
  'home.locked.watch.delete.title_m': 'He\'s no longer here',
  'home.locked.watch.delete.title_f': 'She\'s no longer here',
  'home.locked.watch.delete.desc': 'She left the app or isn\'t available right now. You can move on',
  'home.locked.watch.delete.desc_m': 'He left the app or isn\'t available right now. You can move on',
  'home.locked.watch.delete.desc_f': 'She left the app or isn\'t available right now. You can move on',
  ...
  // Locked invite cards: only the inviter's gender matters in English ("you"
  ...
  'home.locked.invite.cancel.title': 'The invitation was canceled',
  'home.locked.invite.cancel.desc': 'He canceled the invitation before you had a chance to reply. You can go back to being available for others',
  'home.locked.invite.cancel.desc_mm': 'He canceled the invitation before you had a chance to reply. You can go back to being available for others',
  'home.locked.invite.cancel.desc_mf': 'She canceled the invitation before you had a chance to reply. You can go back to being available for others',
  'home.locked.invite.cancel.desc_fm': 'He canceled the invitation before you had a chance to reply. You can go back to being available for others',
  'home.locked.invite.cancel.desc_ff': 'She canceled the invitation before you had a chance to reply. You can go back to being available for others',
  'home.locked.invite.approve.title': 'The invitation is no longer available',
  'home.locked.invite.approve.desc': 'Something changed before you could approve. You can go back to being available for others',
  'home.locked.invite.expire.title': 'The invitation closed',
  'home.locked.invite.expire.desc': 'You didn\'t answer in time, so the invitation is no longer active. You can go back to being available',
  'home.locked.invite.logout.title': 'He\'s no longer here',
  'home.locked.invite.logout.title_mm': 'He\'s no longer here',
  'home.locked.invite.logout.title_mf': 'She\'s no longer here',
  'home.locked.invite.logout.title_fm': 'He\'s no longer here',
  'home.locked.invite.logout.title_ff': 'She\'s no longer here',
  'home.locked.invite.logout.desc': 'He left the app or isn\'t available right now. You can move on',
  'home.locked.invite.logout.desc_mm': 'He left the app or isn\'t available right now. You can move on',
  'home.locked.invite.logout.desc_mf': 'She left the app or isn\'t available right now. You can move on',
  'home.locked.invite.logout.desc_fm': 'He left the app or isn\'t available right now. You can move on',
  'home.locked.invite.logout.desc_ff': 'She left the app or isn\'t available right now. You can move on',
  'home.locked.invite.delete.title': 'He\'s no longer here',
  'home.locked.invite.delete.title_mm': 'He\'s no longer here',
  'home.locked.invite.delete.title_mf': 'She\'s no longer here',
  'home.locked.invite.delete.title_fm': 'He\'s no longer here',
  'home.locked.invite.delete.title_ff': 'She\'s no longer here',
  'home.locked.invite.delete.desc': 'He left the app or isn\'t available right now. You can move on',
  'home.locked.invite.delete.desc_mm': 'He left the app or isn\'t available right now. You can move on',
  'home.locked.invite.delete.desc_mf': 'She left the app or isn\'t available right now. You can move on',
  'home.locked.invite.delete.desc_fm': 'He left the app or isn\'t available right now. You can move on',
  'home.locked.invite.delete.desc_ff': 'She left the app or isn\'t available right now. You can move on',
  ...
  'chat.msgActions.delete': 'Delete message',
