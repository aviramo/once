...
ממשיכים לאפשרות הבאה`,
  ...
  'home.locked.watch.invite.word': 'הוחמצה',
  'home.locked.watch.invite.word_m': 'הוחמץ',
  'home.locked.watch.invite.word_f': 'הוחמצה',
  'home.locked.watch.extend.word': 'הוחמצה',
  'home.locked.watch.extend.word_m': 'הוחמץ',
  'home.locked.watch.extend.word_f': 'הוחמצה',
  'home.locked.watch.approve.word': 'הוחמצה',
  'home.locked.watch.approve.word_m': 'הוחמץ',
  'home.locked.watch.approve.word_f': 'הוחמצה',
  'home.locked.watch.decline.word': 'דחתה',
  'home.locked.watch.decline.word_m': 'דחה',
  'home.locked.watch.decline.word_f': 'דחתה',
  'home.locked.watch.leave.word': 'יצאה',
  'home.locked.watch.leave.word_m': 'יצא',
  'home.locked.watch.leave.word_f': 'יצאה',
  'home.locked.watch.block.word': 'יצאה',
  'home.locked.watch.block.word_m': 'יצא',
  'home.locked.watch.block.word_f': 'יצאה',
  'home.locked.watch.remove.word': 'נעלמה',
  'home.locked.watch.remove.word_m': 'נעלם',
  'home.locked.watch.remove.word_f': 'נעלמה',
  'home.locked.watch.expire.word': 'הסתיים',
  'home.locked.watch.logout.word': 'התנתקה',
  'home.locked.watch.logout.word_m': 'התנתק',
  'home.locked.watch.logout.word_f': 'התנתקה',
  'home.locked.watch.delete.word': 'נמחקה',
  'home.locked.watch.delete.word_m': 'נמחק',
  'home.locked.watch.delete.word_f': 'נמחקה',
  'home.locked.invite.cancel.word': 'בוטל',
  'home.locked.invite.approve.word': 'הוחמצה',
  'home.locked.invite.approve.word_m': 'הוחמץ',
  'home.locked.invite.approve.word_f': 'הוחמצה',
  'home.locked.invite.expire.word': 'הסתיים',
  'home.locked.invite.logout.word': 'התנתקה',
  'home.locked.invite.logout.word_m': 'התנתק',
  'home.locked.invite.logout.word_f': 'התנתקה',
  'home.locked.invite.delete.word': 'נמחקה',
  'home.locked.invite.delete.word_m': 'נמחק',
  'home.locked.invite.delete.word_f': 'נמחקה',
  'home.endedBack': 'חזרה למשחק',

  // Locked-state cards: watch (after a terminal event) and invite (dead invite).
  // Key shape: home.locked.<board>.<message>.{title,desc}
  // Locked watch cards reference the other user ("she/he"). `tg(key, otherMale)`
  ...
  'home.locked.watch.invite.title': 'היא כבר לא זמינה',
  'home.locked.watch.invite.title_m': 'הוא כבר לא זמין',
  'home.locked.watch.invite.title_f': 'היא כבר לא זמינה',
  'home.locked.watch.invite.desc': 'היא כבר בהזמנה אחרת, אז אי אפשר לשלוח לה כרגע. אפשר להמשיך הלאה',
  'home.locked.watch.invite.desc_m': 'הוא כבר בהזמנה אחרת, אז אי אפשר לשלוח לו כרגע. אפשר להמשיך הלאה',
  'home.locked.watch.invite.desc_f': 'היא כבר בהזמנה אחרת, אז אי אפשר לשלוח לה כרגע. אפשר להמשיך הלאה',
  'home.locked.watch.extend.title': 'אי אפשר להאריך',
  'home.locked.watch.extend.desc': 'ההזמנה כבר נסגרה. אפשר לחזור ולמצוא חיבור אחר',
  'home.locked.watch.approve.title': 'החיבור כבר לא זמין',
  'home.locked.watch.approve.desc': 'משהו השתנה לפני שהספקתם להתחבר. אפשר להמשיך הלאה',
  'home.locked.watch.approve.desc_m': 'משהו השתנה לפני שהספקתם להתחבר. אפשר להמשיך הלאה',
  'home.locked.watch.approve.desc_f': 'משהו השתנה לפני שהספקתם להתחבר. אפשר להמשיך הלאה',
  'home.locked.watch.decline.title': 'היא לא אישרה הפעם',
  'home.locked.watch.decline.title_m': 'הוא לא אישר הפעם',
  'home.locked.watch.decline.title_f': 'היא לא אישרה הפעם',
  'home.locked.watch.decline.desc': 'היא בחרה לא להמשיך כרגע. הכול טוב, אפשר לעבור לחיבור הבא',
  'home.locked.watch.decline.desc_m': 'הוא בחר לא להמשיך כרגע. הכול טוב, אפשר לעבור לחיבור הבא',
  'home.locked.watch.decline.desc_f': 'היא בחרה לא להמשיך כרגע. הכול טוב, אפשר לעבור לחיבור הבא',
  'home.locked.watch.leave.title': 'השיחה הסתיימה',
  'home.locked.watch.leave.desc': 'היא יצאה מהשיחה. אפשר לחזור ולמצוא חיבור חדש',
  'home.locked.watch.leave.desc_m': 'הוא יצא מהשיחה. אפשר לחזור ולמצוא חיבור חדש',
  'home.locked.watch.leave.desc_f': 'היא יצאה מהשיחה. אפשר לחזור ולמצוא חיבור חדש',
  'home.locked.watch.block.title': 'השיחה הסתיימה',
  'home.locked.watch.block.desc': 'היא בחרה לסיים את החיבור. אפשר להמשיך הלאה',
  'home.locked.watch.block.desc_m': 'הוא בחר לסיים את החיבור. אפשר להמשיך הלאה',
  'home.locked.watch.block.desc_f': 'היא בחרה לסיים את החיבור. אפשר להמשיך הלאה',
  'home.locked.watch.remove.title': 'היא כבר לא זמינה לך',
  'home.locked.watch.remove.title_m': 'הוא כבר לא זמין לך',
  'home.locked.watch.remove.title_f': 'היא כבר לא זמינה לך',
  'home.locked.watch.remove.desc': 'היא הסירה אותך מרשימת הצופים שלה. אפשר לחזור ולמצוא חיבור אחר',
  'home.locked.watch.remove.desc_m': 'הוא הסיר אותך מרשימת הצופים שלו. אפשר לחזור ולמצוא חיבור אחר',
  'home.locked.watch.remove.desc_f': 'היא הסירה אותך מרשימת הצופים שלה. אפשר לחזור ולמצוא חיבור אחר',
  'home.locked.watch.expire.title': 'היא לא הספיקה לענות',
  'home.locked.watch.expire.title_m': 'הוא לא הספיק לענות',
  'home.locked.watch.expire.title_f': 'היא לא הספיקה לענות',
  'home.locked.watch.expire.desc': 'הזמן עבר ללא תשובה. אפשר להמשיך ולשלוח הזמנה למישהי אחרת',
  'home.locked.watch.expire.desc_m': 'הזמן עבר ללא תשובה. אפשר להמשיך ולשלוח הזמנה למישהו אחר',
  'home.locked.watch.expire.desc_f': 'הזמן עבר ללא תשובה. אפשר להמשיך ולשלוח הזמנה למישהי אחרת',
  'home.locked.watch.logout.title': 'היא כבר לא כאן',
  'home.locked.watch.logout.title_m': 'הוא כבר לא כאן',
  'home.locked.watch.logout.title_f': 'היא כבר לא כאן',
  'home.locked.watch.logout.desc': 'היא יצאה מהאפליקציה או לא זמינה כרגע. אפשר להמשיך הלאה',
  'home.locked.watch.logout.desc_m': 'הוא יצא מהאפליקציה או לא זמין כרגע. אפשר להמשיך הלאה',
  'home.locked.watch.logout.desc_f': 'היא יצאה מהאפליקציה או לא זמינה כרגע. אפשר להמשיך הלאה',
  'home.locked.watch.delete.title': 'היא כבר לא כאן',
  'home.locked.watch.delete.title_m': 'הוא כבר לא כאן',
  'home.locked.watch.delete.title_f': 'היא כבר לא כאן',
  'home.locked.watch.delete.desc': 'היא יצאה מהאפליקציה או לא זמינה כרגע. אפשר להמשיך הלאה',
  'home.locked.watch.delete.desc_m': 'הוא יצא מהאפליקציה או לא זמין כרגע. אפשר להמשיך הלאה',
  'home.locked.watch.delete.desc_f': 'היא יצאה מהאפליקציה או לא זמינה כרגע. אפשר להמשיך הלאה',
  ...
  'home.locked.invite.cancel.title': 'ההזמנה בוטלה',
  'home.locked.invite.cancel.desc': 'הוא ביטל את ההזמנה לפני שהספקת לענות. אפשר לחזור להיות זמין לאחרים',
  'home.locked.invite.cancel.desc_mm': 'הוא ביטל את ההזמנה לפני שהספקת לענות. אפשר לחזור להיות זמין לאחרים',
  'home.locked.invite.cancel.desc_mf': 'היא ביטלה את ההזמנה לפני שהספקת לענות. אפשר לחזור להיות זמין לאחרות',
  'home.locked.invite.cancel.desc_fm': 'הוא ביטל את ההזמנה לפני שהספקת לענות. אפשר לחזור להיות זמינה לאחרים',
  'home.locked.invite.cancel.desc_ff': 'היא ביטלה את ההזמנה לפני שהספקת לענות. אפשר לחזור להיות זמינה לאחרות',
  'home.locked.invite.approve.title': 'ההזמנה כבר לא זמינה',
  'home.locked.invite.approve.desc': 'משהו השתנה לפני שהספקת לאשר. אפשר לחזור להיות זמין לאחרים',
  'home.locked.invite.approve.desc_mm': 'משהו השתנה לפני שהספקת לאשר. אפשר לחזור להיות זמין לאחרים',
  'home.locked.invite.approve.desc_mf': 'משהו השתנה לפני שהספקת לאשר. אפשר לחזור להיות זמין לאחרות',
  'home.locked.invite.approve.desc_fm': 'משהו השתנה לפני שהספקת לאשר. אפשר לחזור להיות זמינה לאחרים',
  'home.locked.invite.approve.desc_ff': 'משהו השתנה לפני שהספקת לאשר. אפשר לחזור להיות זמינה לאחרות',
  'home.locked.invite.expire.title': 'ההזמנה נסגרה',
  'home.locked.invite.expire.desc': 'לא ענית בזמן, אז ההזמנה כבר לא פעילה. אפשר לחזור להיות זמין',
  'home.locked.invite.expire.desc_mm': 'לא ענית בזמן, אז ההזמנה כבר לא פעילה. אפשר לחזור להיות זמין',
  'home.locked.invite.expire.desc_mf': 'לא ענית בזמן, אז ההזמנה כבר לא פעילה. אפשר לחזור להיות זמין',
  'home.locked.invite.expire.desc_fm': 'לא ענית בזמן, אז ההזמנה כבר לא פעילה. אפשר לחזור להיות זמינה',
  'home.locked.invite.expire.desc_ff': 'לא ענית בזמן, אז ההזמנה כבר לא פעילה. אפשר לחזור להיות זמינה',
  'home.locked.invite.logout.title': 'הוא כבר לא כאן',
  'home.locked.invite.logout.title_mm': 'הוא כבר לא כאן',
  'home.locked.invite.logout.title_mf': 'היא כבר לא כאן',
  'home.locked.invite.logout.title_fm': 'הוא כבר לא כאן',
  'home.locked.invite.logout.title_ff': 'היא כבר לא כאן',
  'home.locked.invite.logout.desc': 'הוא יצא מהאפליקציה או לא זמין כרגע. אפשר להמשיך הלאה',
  'home.locked.invite.logout.desc_mm': 'הוא יצא מהאפליקציה או לא זמין כרגע. אפשר להמשיך הלאה',
  'home.locked.invite.logout.desc_mf': 'היא יצאה מהאפליקציה או לא זמינה כרגע. אפשר להמשיך הלאה',
  'home.locked.invite.logout.desc_fm': 'הוא יצא מהאפליקציה או לא זמין כרגע. אפשר להמשיך הלאה',
  'home.locked.invite.logout.desc_ff': 'היא יצאה מהאפליקציה או לא זמינה כרגע. אפשר להמשיך הלאה',
  'home.locked.invite.delete.title': 'הוא כבר לא כאן',
  'home.locked.invite.delete.title_mm': 'הוא כבר לא כאן',
  'home.locked.invite.delete.title_mf': 'היא כבר לא כאן',
  'home.locked.invite.delete.title_fm': 'הוא כבר לא כאן',
  'home.locked.invite.delete.title_ff': 'היא כבר לא כאן',
  'home.locked.invite.delete.desc': 'הוא יצא מהאפליקציה או לא זמין כרגע. אפשר להמשיך הלאה',
  'home.locked.invite.delete.desc_mm': 'הוא יצא מהאפליקציה או לא זמין כרגע. אפשר להמשיך הלאה',
  'home.locked.invite.delete.desc_mf': 'היא יצאה מהאפליקציה או לא זמינה כרגע. אפשר להמשיך הלאה',
  'home.locked.invite.delete.desc_fm': 'הוא יצא מהאפליקציה או לא זמין כרגע. אפשר להמשיך הלאה',
  'home.locked.invite.delete.desc_ff': 'היא יצאה מהאפליקציה או לא זמינה כרגע. אפשר להמשיך הלאה',
  ...
  'chat.msgActions.delete': 'מחיקת ההודעה',
  // What a deleted bubble says in place of its content
