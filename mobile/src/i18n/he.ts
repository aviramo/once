...
הבא יפתיע`,
  ...
  'home.locked.page1.invite.desc_m': 'הוא נכנס לפוקוס אחר, אז אי אפשר לשלוח לו הזמנה כרגע. אפשר להמשיך לחפש.',
  'home.locked.page1.invite.desc_f': 'היא נכנסה לפוקוס אחר, אז אי אפשר לשלוח לה הזמנה כרגע. אפשר להמשיך לחפש.',
  ...
  'home.locked.page1.approve.desc_m': 'משהו השתנה לפני שהספקתם להתחבר. אפשר להמשיך הלאה ולמצוא מישהו אחר.',
  'home.locked.page1.approve.desc_f': 'משהו השתנה לפני שהספקתם להתחבר. אפשר להמשיך הלאה ולמצוא מישהי אחרת.',
  ...
  'home.locked.page1.decline.desc_m': 'ההזמנה שלך לא התאימה לו כרגע. הכול טוב, אפשר להמשיך לחיבור הבא.',
  'home.locked.page1.decline.desc_f': 'ההזמנה שלך לא התאימה לה כרגע. הכול טוב, אפשר להמשיך לחיבור הבא.',
  'home.locked.page1.leave.title': 'השיחה הסתיימה',
  'home.locked.page1.leave.desc': 'היא בחרה לצאת מהשיחה. אפשר לחזור ולמצוא חיבור חדש.',
  'home.locked.page1.leave.desc_m': 'הוא בחר לצאת מהשיחה. אפשר לחזור ולמצוא חיבור חדש.',
  'home.locked.page1.leave.desc_f': 'היא בחרה לצאת מהשיחה. אפשר לחזור ולמצוא חיבור חדש.',
  ...
  'home.locked.page1.remove.desc_m': 'הוא הסיר אותך מהצופים שלו כרגע. אפשר לחזור ולמצוא חיבור אחר.',
  'home.locked.page1.remove.desc_f': 'היא הסירה אותך מהצופים שלה כרגע. אפשר לחזור ולמצוא חיבור אחר.',
  ...
  'home.locked.page1.expire.desc_m': 'ההזמנה נשארה בלי תגובה. אפשר להמשיך ולשלוח הזמנה למישהו אחר.',
  'home.locked.page1.expire.desc_f': 'ההזמנה נשארה בלי תגובה. אפשר להמשיך ולשלוח הזמנה למישהי אחרת.',
  ...
  'home.locked.page2.cancel.desc': 'הוא ביטל את ההזמנה לפני שהספקת לענות. אפשר לחזור ולהיות זמין לאחרים.',
  'home.locked.page2.cancel.desc_mm': 'הוא ביטל את ההזמנה לפני שהספקת לענות. אפשר לחזור ולהיות זמין לאחרים.',
  'home.locked.page2.cancel.desc_mf': 'היא ביטלה את ההזמנה לפני שהספקת לענות. אפשר לחזור ולהיות זמין לאחרות.',
  'home.locked.page2.cancel.desc_fm': 'הוא ביטל את ההזמנה לפני שהספקת לענות. אפשר לחזור ולהיות זמינה לאחרים.',
  'home.locked.page2.cancel.desc_ff': 'היא ביטלה את ההזמנה לפני שהספקת לענות. אפשר לחזור ולהיות זמינה לאחרות.',
  'home.locked.page2.approve.title': 'החיבור אושר',
  'home.locked.page2.approve.desc': 'אתם עוברים לשיחה. רגע קטן וזה מתחיל.',
  'home.locked.page2.approve.desc_mm': 'אתם עוברים לשיחה. רגע קטן וזה מתחיל.',
  'home.locked.page2.approve.desc_mf': 'אתם עוברים לשיחה. רגע קטן וזה מתחיל.',
  'home.locked.page2.approve.desc_fm': 'אתם עוברים לשיחה. רגע קטן וזה מתחיל.',
  'home.locked.page2.approve.desc_ff': 'אתן עוברות לשיחה. רגע קטן וזה מתחיל.',
