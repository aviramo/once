export default {
  ...
  'settings.profileSubtitle': 'צפייה ועריכה של הפרופיל שלך',
  ...
  'home.watchingMePhotosHidden': 'התמונות מוסתרות עד שתתחברו',
  'home.watchingMeMorePeopleNearby': 'ייתכן שיש עוד אנשים בסביבה',
  'home.watchingMeNoOneTitle': 'אף אחד לא צופה בך כרגע',
  'home.watchingMeNoOneSubtitle': 'אבל זה יכול להשתנות בכל רגע...',
  'home.watchingMeNoOneDesc': 'אף אחד לא מסתכל על הפרופיל שלך כרגע. אפשר לחזור מאוחר יותר, אנשים חדשים עשויים להתעניין בך.',
  ...
  'home.inviteConfirmTitle': 'להכיר את {name}?',
  'home.inviteConfirmDesc': 'תתמקד עכשיו רק ב{name}. אחרים לא יהיו זמינים יותר.',
  'home.inviteConfirmDesc_mm': 'תתמקד עכשיו רק ב{name}. אחרים לא יהיו זמינים יותר.',
  'home.inviteConfirmDesc_mf': 'תתמקד עכשיו רק ב{name}. אחרות לא יהיו זמינות יותר.',
  'home.inviteConfirmDesc_fm': 'תתמקדי עכשיו רק ב{name}. אחרים לא יהיו זמינים יותר.',
  'home.inviteConfirmDesc_ff': 'תתמקדי עכשיו רק ב{name}. אחרות לא יהיו זמינות יותר.',
  'home.inviteConfirmOk': 'כן, להכיר',
  ...
  'home.waitingNoInvitesTitle': 'הוא לא יקבל הזמנות מאחרים',
  'home.waitingNoInvitesTitle_m': 'הוא לא יקבל הזמנות מאחרים',
  'home.waitingNoInvitesTitle_f': 'היא לא תקבל הזמנות מאחרים',
  'home.waitingNoInvitesSubtext': 'עד שיענה לך.',
  'home.waitingNoInvitesSubtext_m': 'עד שיענה לך.',
  'home.waitingNoInvitesSubtext_f': 'עד שתענה לך.',
  ...
  'home.watchingTitle': 'מישהו בקרבתך',
  'home.watchingAccept': 'להכיר',
  'home.watchingAccept_m': 'להכיר אותו',
  'home.watchingAccept_f': 'להכיר אותה',
  ...
  'home.noOneNearbyDesc_m': 'לא מצאנו אף אחד בסביבתך. נסה שוב בעוד זמן מה.',
  'home.noOneNearbyDesc_f': 'לא מצאנו אף אחד בסביבתך. נסי שוב בעוד זמן מה.',
