...
import { STATUS_BAND } from '../colors'

// The purple band behind the OS status bar. Single source of truth for the
      ...
      <Svg width="100%" height="100%">
        <Defs>
          <LinearGradient id="statusBand" x1="0" y1="0" x2="0" y2="1">
            <Stop offset="0" stopColor={STATUS_BAND} stopOpacity={0.5} />
            <Stop offset="1" stopColor={STATUS_BAND} stopOpacity={0} />
          </LinearGradient>
        </Defs>
