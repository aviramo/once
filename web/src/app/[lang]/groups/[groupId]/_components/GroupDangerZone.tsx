...
export type GroupDangerDict = {
  ...
  /** Confirm body — {name} and {count} interpolated (count = current members
   * that will be detached as part of the delete). */
 ...
 * UserDangerZone shape so the two pages read the same. Deleting a group also
 * detaches every member from it (the users themselves are untouched); the
 * confirm body spells out how many memberships will be removed so the
 * operator knows the blast radius before committing.
 */
